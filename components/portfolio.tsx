      ...
      <header className="nav-wrap">
        <nav className="nav container" aria-label="Primary navigation">
          ...
          <Button asChild variant="outline" className="nav-cta">
            <Link href="https://calendly.com/talk-divjot/chit-chat">Let&apos;s talk <ArrowUpRight /></Link>
          </Button>
        ...
        {menuOpen && (
          <motion.div className="mobile-menu" initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <Link href="https://calendly.com/talk-divjot/chit-chat" onClick={() => setMenuOpen(false)}>Start a conversation<ArrowRight /></Link>
          </motion.div>
        )}
      </header>
      ...
      <section className="hero container" id="top">
        <div className="hero-copy">
          ...
          >
            ...
            <Button asChild variant="outline"><Link href="https://calendly.com/talk-divjot/chit-chat">Start a conversation</Link></Button>
          </motion.div>
          <motion.div
      ...
      <section className="philosophy-section">
        ...
        <div className="container philosophy-inner">
          <Reveal>
            ...
            <Button asChild><Link href="https://calendly.com/talk-divjot/chit-chat">Build something meaningful <ArrowRight /></Link></Button>
          </Reveal>
        </div>
      </section>
        ...
        <div className="container">
          <div className="footer-top">
            ...
            <Reveal className="footer-action" delay={0.1}>
              <Link href="https://calendly.com/talk-divjot/chit-chat"><span>Tell me about it</span><ArrowRight /></Link>
          ...
          <div className="footer-bottom">
            ...
            <div className="socials">
              ...
              <Link href="mailto:aroradivjotsingh@gmail.com" aria-label="Email"><Mail /></Link>
            </div>
